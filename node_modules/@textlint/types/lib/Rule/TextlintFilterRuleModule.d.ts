 ...
 */
export declare type TextlintFilterRuleReporter = (context: Readonly<TextlintFilterRuleContext>, options?: TextlintFilterRuleOptions) => TextlintFilterRuleReportHandler;
/**
 * textlint filter module exports
 * Currently, module.exports = reporter;
 */
export declare type TextlintFilterRuleModule = TextlintFilterRuleReporter;
