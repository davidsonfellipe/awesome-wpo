...
- [Foglift](https://foglift.io) - Free website analyzer covering performance, SEO, GEO (AI search readiness), security, and accessibility. Includes a public API and CLI.
